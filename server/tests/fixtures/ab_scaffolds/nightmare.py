...
PIONEER_PROMPT = (
    "Get the Hive server running. I've solved this before — follow these exact steps:\n\n"
    "Step 1: Fix .env — replace the entire file with:\n"
    "DATABASE_URL=postgresql://localhost:5432/hive\n"
    "SECRET_KEY=overmind-nightmare-secret-2026\n"
    ...
    "Step 4: Fix plugins/registry.json — add \"enabled\": true to each plugin object.\n\n"
    "Step 5: Run `bash start.sh` to verify everything works.\n\n"
    "You may edit config.toml, .env, secrets/hmac.key, plugins/registry.json. "
    "Do NOT modify files under src/ or create new files."
)
